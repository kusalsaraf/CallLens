"""Alembic migration environment — async engine wired to the app's declarative base."""
...
def do_run_migrations(connection: object) -> None:
    ...
    Args:
        connection: A synchronous DBAPI connection provided by the async engine bridge.
    """
